...
public class VentanaPrincipal extends JFrame{
	...
	public VentanaPrincipal(Principal principal, Usuario usuario) {
		...
		Image fotoPerros = new ImageIcon("imagenes/fondoPatron.jpg").getImage();
		PanelConFondo panelCentro = new PanelConFondo(fotoPerros);
		...
		Image fotoPatron = new ImageIcon("imagenes/Fondo Blanco.jpg").getImage();
		PanelConFondo panelDerecho = new PanelConFondo(fotoPatron);
		...
		panelDerecho.setBorder(new EmptyBorder(40,50,20,50));
